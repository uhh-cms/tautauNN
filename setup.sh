...
action() {
    ...
    if [[ "$( hostname )" = max-*.desy.de ]]; then
        ...
        export TN_SKIMS_2016APV="/gpfs/dust/cms/user/kramerto/hbt_resonant_run2/HHSkims/SKIMS_UL16APC"
        ...
        export TN_SKIMS_2016APC="/eos/user/l/lportale/hhbbtautau/skims/SKIMS_UL16APV"
