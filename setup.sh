...
action() {
    ...
    if [[ "$( hostname )" = max-*.desy.de ]]; then
        # maxwell
        export TN_DATA_DIR="/data/dust/cms/user/${user_name}/taunn_data"
        export TN_SOFTWARE_DIR="${TN_DATA_DIR}/software_maxwell"
        export TN_REG_MODEL_DIR="/data/dust/cms/user/riegerma/taunn_data/reg_models"
        export TN_STORE_DIR_TOBI="/data/dust/cms/user/kramerto/taunn_data/store"
        export TN_STORE_DIR_MARCEL="/data/dust/cms/user/riegerma/taunn_data/store"
        export TN_SKIMS_2016APV="/data/dust/cms/user/kramerto/hbt_resonant_run2/HHSkims/SKIMS_UL16APV"
        export TN_SKIMS_2016="/data/dust/cms/user/kramerto/hbt_resonant_run2/HHSkims/SKIMS_UL16"
        # export TN_SKIMS_2017="/data/dust/cms/user/kramerto/hbt_resonant_run2/HHSkims/SKIMS_UL17"
        export TN_SKIMS_2017="/data/dust/cms/user/kramerto/hbt_resonant_run2/HHSkims/SKIMS_UL17_uhh_2017_v6_06Aug24/"
        export TN_SKIMS_2018="/data/dust/cms/user/kramerto/hbt_resonant_run2/HHSkims/SKIMS_UL18"
        ...
        export TN_STORE_DIR_TOBI="/nfs/dust/cms/user/kramerto/taunn_data/store"
